...
class HdrGRH(rdma.binstruct.BinStruct):
    ...
    @property
    def _pack_1_32(self):
        return ((self.payLen & 0xFFFF) << 16) | ((self.nxtHdr & 0xFF) << 8) | ((self.hopLmt & 0xFF) << 0)

    @_pack_1_32.setter
    def _pack_1_32(self,value):
        self.payLen = (value >> 16) & 0xFFFF;
        self.nxtHdr = (value >> 8) & 0xFF;
...
class CMREQ(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        ...
        struct.pack_into('>LLQQLLLLLLL',buffer,offset+0,self.LCID,self.reserved1,self.serviceID,self.LGUID,self.localCMQKey,self.localQKey,self._pack_0_32,self._pack_1_32,self._pack_2_32,self._pack_3_32,self._pack_4_32);
    ...
    def unpack_from(self,buffer,offset=0):
        ...
        (self.LCID,self.reserved1,self.serviceID,self.LGUID,self.localCMQKey,self.localQKey,self._pack_0_32,self._pack_1_32,self._pack_2_32,self._pack_3_32,self._pack_4_32,) = struct.unpack_from('>LLQQLLLLLLL',buffer,offset+0);
...
class CMREP(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        ...
        struct.pack_into('>LLLLLLLQ',buffer,offset+0,self.LCID,self.RCID,self.localQKey,self._pack_0_32,self._pack_1_32,self._pack_2_32,self._pack_3_32,self.LGUID);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.privateData = buffer[offset + 36:offset + 232]
        (self.LCID,self.RCID,self.localQKey,self._pack_0_32,self._pack_1_32,self._pack_2_32,self._pack_3_32,self.LGUID,) = struct.unpack_from('>LLLLLLLQ',buffer,offset+0);
...
class SMPGUIDBlock(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        struct.pack_into('>Q',buffer,offset+0,self.GUID);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        (self.GUID,) = struct.unpack_from('>Q',buffer,offset+0);
...
class SMPFormat(rdma.binstruct.BinStruct):
    ...
    def zero(self):
        self.MADHeader = MADHeader();
        self.MKey = 0;
        self.reserved1 = bytearray(32);
        self.data = bytearray(64);
        self.reserved2 = bytearray(128);

    def pack_into(self,buffer,offset=0):
        self.MADHeader.pack_into(buffer,offset + 0);
        buffer[offset + 32:offset + 64] = self.reserved1
        buffer[offset + 64:offset + 128] = self.data
        buffer[offset + 128:offset + 256] = self.reserved2
        struct.pack_into('>Q',buffer,offset+24,self.MKey);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.MADHeader.unpack_from(buffer,offset + 0);
        self.reserved1 = buffer[offset + 32:offset + 64]
        self.data = buffer[offset + 64:offset + 128]
        self.reserved2 = buffer[offset + 128:offset + 256]
        (self.MKey,) = struct.unpack_from('>Q',buffer,offset+24);
...
class SMPFormatDirected(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.MADHeader.pack_into(buffer,offset + 0);
        buffer[offset + 36:offset + 64] = self.reserved1
        buffer[offset + 64:offset + 128] = self.data
        buffer[offset + 128:offset + 192] = self.initialPath
        buffer[offset + 192:offset + 256] = self.returnPath
        struct.pack_into('>QHH',buffer,offset+24,self.MKey,self.drSLID,self.drDLID);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.MADHeader.unpack_from(buffer,offset + 0);
        self.reserved1 = buffer[offset + 36:offset + 64]
        self.data = buffer[offset + 64:offset + 128]
        self.initialPath = buffer[offset + 128:offset + 192]
        self.returnPath = buffer[offset + 192:offset + 256]
        (self.MKey,self.drSLID,self.drDLID,) = struct.unpack_from('>QHH',buffer,offset+24);
...
class SMPNodeInfo(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        struct.pack_into('>BBBBQQQHHLL',buffer,offset+0,self.baseVersion,self.classVersion,self.nodeType,self.numPorts,self.systemImageGUID,self.nodeGUID,self.portGUID,self.partitionCap,self.deviceID,self.revision,self._pack_0_32);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        (self.baseVersion,self.classVersion,self.nodeType,self.numPorts,self.systemImageGUID,self.nodeGUID,self.portGUID,self.partitionCap,self.deviceID,self.revision,self._pack_0_32,) = struct.unpack_from('>BBBBQQQHHLL',buffer,offset+0);
...
class SMPGUIDInfo(rdma.binstruct.BinStruct):
    ...
    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.GUIDBlock[0].unpack_from(buffer,offset + 0);
        self.GUIDBlock[1].unpack_from(buffer,offset + 8);
        self.GUIDBlock[2].unpack_from(buffer,offset + 16);
        self.GUIDBlock[3].unpack_from(buffer,offset + 24);
        self.GUIDBlock[4].unpack_from(buffer,offset + 32);
        self.GUIDBlock[5].unpack_from(buffer,offset + 40);
        self.GUIDBlock[6].unpack_from(buffer,offset + 48);
        self.GUIDBlock[7].unpack_from(buffer,offset + 56);
...
class SMPSLToVLMappingTable(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        rdma.binstruct.packArray8(buffer,0,4,16,self.SLtoVL);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        rdma.binstruct.unpackArray8(buffer,0,4,16,self.SLtoVL);
...
class SMPSMInfo(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        struct.pack_into('>QQLL',buffer,offset+0,self.GUID,self.SMKey,self.actCount,self._pack_0_32);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        (self.GUID,self.SMKey,self.actCount,self._pack_0_32,) = struct.unpack_from('>QQLL',buffer,offset+0);
...
class SAFormat(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.SAHeader.pack_into(buffer,offset + 0);
        buffer[offset + 56:offset + 256] = self.data

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.SAHeader.unpack_from(buffer,offset + 0);
        self.data = buffer[offset + 56:offset + 256]

    def printer(self,F,offset=0,*args):
        rdma.binstruct.BinStruct.printer(self,F,offset,*args);
        label = "SAHeader=%r"%(self.SAHeader);
        self.dump(F,0,448,label,offset);
        label = "data=%r"%(self.data);
...
class SANodeRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.nodeInfo.pack_into(buffer,offset + 32);
        self.nodeDescription.pack_into(buffer,offset + 352);
        struct.pack_into('>HH',buffer,offset+0,self.LID,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.nodeInfo.unpack_from(buffer,offset + 32);
        self.nodeDescription.unpack_from(buffer,offset + 352);
...
class SAPortInfoRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.portInfo.pack_into(buffer,offset + 32);
        struct.pack_into('>HBB',buffer,offset+0,self.endportLID,self.portNum,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.portInfo.unpack_from(buffer,offset + 32);
...
class SASLToVLMappingTableRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.SLToVLMappingTable.pack_into(buffer,offset + 64);
        struct.pack_into('>HBBL',buffer,offset+0,self.LID,self.inputPortNum,self.outputPortNum,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.SLToVLMappingTable.unpack_from(buffer,offset + 64);
...
class SASwitchInfoRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.switchInfo.pack_into(buffer,offset + 32);
        struct.pack_into('>HH',buffer,offset+0,self.LID,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.switchInfo.unpack_from(buffer,offset + 32);
        (self.LID,self.reserved1,) = struct.unpack_from('>HH',buffer,offset+0);
...
class SALinearForwardingTableRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.linearForwardingTable.pack_into(buffer,offset + 64);
        struct.pack_into('>HHL',buffer,offset+0,self.LID,self.blockNum,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.linearForwardingTable.unpack_from(buffer,offset + 64);
...
class SARandomForwardingTableRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.randomForwardingTable.pack_into(buffer,offset + 64);
        struct.pack_into('>HHL',buffer,offset+0,self.LID,self.blockNum,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.randomForwardingTable.unpack_from(buffer,offset + 64);
        (self.LID,self.blockNum,self.reserved1,) = struct.unpack_from('>HHL',buffer,offset+0);
...
class SAMulticastForwardingTableRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.multicastForwardingTable.pack_into(buffer,offset + 64);
        struct.pack_into('>LL',buffer,offset+0,self._pack_0_32,self.reserved2);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.multicastForwardingTable.unpack_from(buffer,offset + 64);
...
class SAVLArbitrationTableRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.VLArbitrationTable.pack_into(buffer,offset + 64);
        struct.pack_into('>HBBL',buffer,offset+0,self.LID,self.outputPortNum,self.blockNum,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.VLArbitrationTable.unpack_from(buffer,offset + 64);
...
class SASMInfoRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.SMInfo.pack_into(buffer,offset + 32);
        struct.pack_into('>HH',buffer,offset+0,self.LID,self.reserved1);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.SMInfo.unpack_from(buffer,offset + 32);
        (self.LID,self.reserved1,) = struct.unpack_from('>HH',buffer,offset+0);
...
class SAServiceRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        ...
        rdma.binstruct.packArray8(buffer,1280,64,2,self.serviceData64);
    ...
    def unpack_from(self,buffer,offset=0):
        ...
        rdma.binstruct.unpackArray8(buffer,1280,64,2,self.serviceData64);
...
class SAPKeyTableRecord(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.PKeyTable.pack_into(buffer,offset + 64);
        struct.pack_into('>HHL',buffer,offset+0,self.LID,self.blockNum,self._pack_0_32);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.PKeyTable.unpack_from(buffer,offset + 64);
...
class PMFormat(rdma.binstruct.BinStruct):
    ...
    def zero(self):
        self.MADHeader = MADHeader();
        self.reserved1 = bytearray(40);
        self.data = bytearray(192);

    def pack_into(self,buffer,offset=0):
        self.MADHeader.pack_into(buffer,offset + 0);
        buffer[offset + 24:offset + 64] = self.reserved1
        buffer[offset + 64:offset + 256] = self.data

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.MADHeader.unpack_from(buffer,offset + 0);
        self.reserved1 = buffer[offset + 24:offset + 64]
...
class PMPortVLXmitFlowCtlUpdateErrors(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        rdma.binstruct.packArray8(buffer,32,2,16,self.portVLXmitFlowCtlUpdateErrors);
        struct.pack_into('>BBH',buffer,offset+0,self.reserved1,self.portSelect,self.counterSelect);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        rdma.binstruct.unpackArray8(buffer,32,2,16,self.portVLXmitFlowCtlUpdateErrors);
...
class PMPortSamplesResExt(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        rdma.binstruct.packArray8(buffer,64,64,15,self.counter);
        struct.pack_into('>LL',buffer,offset+0,self._pack_0_32,self._pack_1_32);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        rdma.binstruct.unpackArray8(buffer,64,64,15,self.counter);
        (self._pack_0_32,self._pack_1_32,) = struct.unpack_from('>LL',buffer,offset+0);
...
class DMIOControllerProfile(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        ...
        struct.pack_into('>QLLHHLLHHHHHHHBBLLBBBBQ',buffer,offset+0,self.GUID,self._pack_0_32,self.deviceID,self.deviceVersion,self.reserved2,self._pack_1_32,self.subsystemID,self.IOClass,self.IOSubclass,self.protocol,self.protocolVersion,self.reserved4,self.reserved5,self.sendMessageDepth,self.reserved6,self.RDMAReadDepth,self.sendMessageSize,self.RDMATransferSize,self.controllerOperationsMask,self.reserved7,self.serviceEntries,self.reserved8,self.reserved9);

    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.IDString = buffer[offset + 64:offset + 128]
        (self.GUID,self._pack_0_32,self.deviceID,self.deviceVersion,self.reserved2,self._pack_1_32,self.subsystemID,self.IOClass,self.IOSubclass,self.protocol,self.protocolVersion,self.reserved4,self.reserved5,self.sendMessageDepth,self.reserved6,self.RDMAReadDepth,self.sendMessageSize,self.RDMATransferSize,self.controllerOperationsMask,self.reserved7,self.serviceEntries,self.reserved8,self.reserved9,) = struct.unpack_from('>QLLHHLLHHHHHHHBBLLBBBBQ',buffer,offset+0);
...
class SNMPFormat(rdma.binstruct.BinStruct):
    ...
    def pack_into(self,buffer,offset=0):
        self.MADHeader.pack_into(buffer,offset + 0);
        buffer[offset + 24:offset + 56] = self.reserved1
        buffer[offset + 64:offset + 256] = self.data
    ...
    def unpack_from(self,buffer,offset=0):
        self._buf = buffer[offset:];
        self.MADHeader.unpack_from(buffer,offset + 0);
        self.reserved1 = buffer[offset + 24:offset + 56]
        self.data = buffer[offset + 64:offset + 256]
