...
class structs_test(unittest.TestCase):
    ...
    def test_struct_printer(self):
        ...
        IBA.HdrRWH().printer(sys.stdout,format="dotted");
        IBA.HdrGRH().printer(sys.stdout);
        IBA.HdrGRH().printer(sys.stdout,format="dotted");
        IBA.HdrBTH().printer(sys.stdout);
        IBA.HdrBTH().printer(sys.stdout,format="dotted");
        IBA.HdrRDETH().printer(sys.stdout);
        IBA.HdrRDETH().printer(sys.stdout,format="dotted");
        IBA.HdrDETH().printer(sys.stdout);
        IBA.HdrDETH().printer(sys.stdout,format="dotted");
        IBA.HdrRETH().printer(sys.stdout);
        IBA.HdrRETH().printer(sys.stdout,format="dotted");
        IBA.HdrAtomicETH().printer(sys.stdout);
        IBA.HdrAtomicETH().printer(sys.stdout,format="dotted");
        IBA.HdrAETH().printer(sys.stdout);
        IBA.HdrAETH().printer(sys.stdout,format="dotted");
        IBA.HdrAtomicAckETH().printer(sys.stdout);
        IBA.HdrAtomicAckETH().printer(sys.stdout,format="dotted");
        IBA.HdrImmDt().printer(sys.stdout);
        IBA.HdrImmDt().printer(sys.stdout,format="dotted");
        IBA.HdrIETH().printer(sys.stdout);
        IBA.HdrIETH().printer(sys.stdout,format="dotted");
        IBA.HdrFlowControl().printer(sys.stdout);
        IBA.HdrFlowControl().printer(sys.stdout,format="dotted");
        IBA.CMFormat().printer(sys.stdout);
        IBA.CMFormat().printer(sys.stdout,format="dotted");
        IBA.CMPath().printer(sys.stdout);
        IBA.CMPath().printer(sys.stdout,format="dotted");
        IBA.CMREQ().printer(sys.stdout);
        IBA.CMREQ().printer(sys.stdout,format="dotted");
        IBA.CMMRA().printer(sys.stdout);
        IBA.CMMRA().printer(sys.stdout,format="dotted");
        IBA.CMREJ().printer(sys.stdout);
        IBA.CMREJ().printer(sys.stdout,format="dotted");
        IBA.CMREP().printer(sys.stdout);
        IBA.CMREP().printer(sys.stdout,format="dotted");
        IBA.CMRTU().printer(sys.stdout);
        IBA.CMRTU().printer(sys.stdout,format="dotted");
        IBA.CMDREQ().printer(sys.stdout);
        IBA.CMDREQ().printer(sys.stdout,format="dotted");
        IBA.CMDREP().printer(sys.stdout);
        IBA.CMDREP().printer(sys.stdout,format="dotted");
        IBA.CMLAP().printer(sys.stdout);
        IBA.CMLAP().printer(sys.stdout,format="dotted");
        IBA.CMAPR().printer(sys.stdout);
        IBA.CMAPR().printer(sys.stdout,format="dotted");
        IBA.CMSIDR_REQ().printer(sys.stdout);
        IBA.CMSIDR_REQ().printer(sys.stdout,format="dotted");
        IBA.CMSIDR_REP().printer(sys.stdout);
        IBA.CMSIDR_REP().printer(sys.stdout,format="dotted");
        IBA.MADHeader().printer(sys.stdout);
        IBA.MADHeader().printer(sys.stdout,format="dotted");
        IBA.MADHeaderDirected().printer(sys.stdout);
        IBA.MADHeaderDirected().printer(sys.stdout,format="dotted");
        IBA.MADClassPortInfo().printer(sys.stdout);
        IBA.MADClassPortInfo().printer(sys.stdout,format="dotted");
        IBA.MADInformInfo().printer(sys.stdout);
        IBA.MADInformInfo().printer(sys.stdout,format="dotted");
        IBA.RMPPHeader().printer(sys.stdout);
        IBA.RMPPHeader().printer(sys.stdout,format="dotted");
        IBA.RMPPShortHeader().printer(sys.stdout);
        IBA.RMPPShortHeader().printer(sys.stdout,format="dotted");
        IBA.RMPPData().printer(sys.stdout);
        IBA.RMPPData().printer(sys.stdout,format="dotted");
        IBA.RMPPAck().printer(sys.stdout);
        IBA.RMPPAck().printer(sys.stdout,format="dotted");
        IBA.RMPPAbort().printer(sys.stdout);
        IBA.RMPPAbort().printer(sys.stdout,format="dotted");
        IBA.RMPPStop().printer(sys.stdout);
        IBA.RMPPStop().printer(sys.stdout,format="dotted");
        IBA.SMPLIDPortBlock().printer(sys.stdout);
        IBA.SMPLIDPortBlock().printer(sys.stdout,format="dotted");
        IBA.SMPFormat().printer(sys.stdout);
        IBA.SMPFormat().printer(sys.stdout,format="dotted");
        IBA.SMPFormatDirected().printer(sys.stdout);
        IBA.SMPFormatDirected().printer(sys.stdout,format="dotted");
        IBA.SMPNodeDescription().printer(sys.stdout);
        IBA.SMPNodeDescription().printer(sys.stdout,format="dotted");
        IBA.SMPNodeInfo().printer(sys.stdout);
        IBA.SMPNodeInfo().printer(sys.stdout,format="dotted");
        IBA.SMPSwitchInfo().printer(sys.stdout);
        IBA.SMPSwitchInfo().printer(sys.stdout,format="dotted");
        IBA.SMPGUIDInfo().printer(sys.stdout);
        IBA.SMPGUIDInfo().printer(sys.stdout,format="dotted");
        IBA.SMPPortInfo().printer(sys.stdout);
        IBA.SMPPortInfo().printer(sys.stdout,format="dotted");
        IBA.SMPPKeyTable().printer(sys.stdout);
        IBA.SMPPKeyTable().printer(sys.stdout,format="dotted");
        IBA.SMPSLToVLMappingTable().printer(sys.stdout);
        IBA.SMPSLToVLMappingTable().printer(sys.stdout,format="dotted");
        IBA.SMPVLArbitrationTable().printer(sys.stdout);
        IBA.SMPVLArbitrationTable().printer(sys.stdout,format="dotted");
        IBA.SMPLinearForwardingTable().printer(sys.stdout);
        IBA.SMPLinearForwardingTable().printer(sys.stdout,format="dotted");
        IBA.SMPRandomForwardingTable().printer(sys.stdout);
        IBA.SMPRandomForwardingTable().printer(sys.stdout,format="dotted");
        IBA.SMPMulticastForwardingTable().printer(sys.stdout);
        IBA.SMPMulticastForwardingTable().printer(sys.stdout,format="dotted");
        IBA.SMPSMInfo().printer(sys.stdout);
        IBA.SMPSMInfo().printer(sys.stdout,format="dotted");
        IBA.SMPVendorDiag().printer(sys.stdout);
        IBA.SMPVendorDiag().printer(sys.stdout,format="dotted");
        IBA.SMPLedInfo().printer(sys.stdout);
        IBA.SMPLedInfo().printer(sys.stdout,format="dotted");
        IBA.SAHeader().printer(sys.stdout);
        IBA.SAHeader().printer(sys.stdout,format="dotted");
        IBA.SAFormat().printer(sys.stdout);
        IBA.SAFormat().printer(sys.stdout,format="dotted");
        IBA.SANodeRecord().printer(sys.stdout);
        IBA.SANodeRecord().printer(sys.stdout,format="dotted");
        IBA.SAPortInfoRecord().printer(sys.stdout);
        IBA.SAPortInfoRecord().printer(sys.stdout,format="dotted");
        IBA.SASLToVLMappingTableRecord().printer(sys.stdout);
        IBA.SASLToVLMappingTableRecord().printer(sys.stdout,format="dotted");
        IBA.SASwitchInfoRecord().printer(sys.stdout);
        IBA.SASwitchInfoRecord().printer(sys.stdout,format="dotted");
        IBA.SALinearForwardingTableRecord().printer(sys.stdout);
        IBA.SALinearForwardingTableRecord().printer(sys.stdout,format="dotted");
        IBA.SARandomForwardingTableRecord().printer(sys.stdout);
        IBA.SARandomForwardingTableRecord().printer(sys.stdout,format="dotted");
        IBA.SAMulticastForwardingTableRecord().printer(sys.stdout);
        IBA.SAMulticastForwardingTableRecord().printer(sys.stdout,format="dotted");
        IBA.SAVLArbitrationTableRecord().printer(sys.stdout);
        IBA.SAVLArbitrationTableRecord().printer(sys.stdout,format="dotted");
        IBA.SASMInfoRecord().printer(sys.stdout);
        IBA.SASMInfoRecord().printer(sys.stdout,format="dotted");
        IBA.SAInformInfoRecord().printer(sys.stdout);
        IBA.SAInformInfoRecord().printer(sys.stdout,format="dotted");
        IBA.SALinkRecord().printer(sys.stdout);
        IBA.SALinkRecord().printer(sys.stdout,format="dotted");
        IBA.SAGUIDInfoRecord().printer(sys.stdout);
        IBA.SAGUIDInfoRecord().printer(sys.stdout,format="dotted");
        IBA.SAServiceRecord().printer(sys.stdout);
        IBA.SAServiceRecord().printer(sys.stdout,format="dotted");
        IBA.SAPKeyTableRecord().printer(sys.stdout);
        IBA.SAPKeyTableRecord().printer(sys.stdout,format="dotted");
        IBA.SAPathRecord().printer(sys.stdout);
        IBA.SAPathRecord().printer(sys.stdout,format="dotted");
        IBA.SAMCMemberRecord().printer(sys.stdout);
        IBA.SAMCMemberRecord().printer(sys.stdout,format="dotted");
        IBA.SATraceRecord().printer(sys.stdout);
        IBA.SATraceRecord().printer(sys.stdout,format="dotted");
        IBA.SAMultiPathRecord().printer(sys.stdout);
        IBA.SAMultiPathRecord().printer(sys.stdout,format="dotted");
        IBA.SAServiceAssociationRecord().printer(sys.stdout);
        IBA.SAServiceAssociationRecord().printer(sys.stdout,format="dotted");
        IBA.PMFormat().printer(sys.stdout);
        IBA.PMFormat().printer(sys.stdout,format="dotted");
        IBA.PMPortSamplesCtl().printer(sys.stdout);
        IBA.PMPortSamplesCtl().printer(sys.stdout,format="dotted");
        IBA.PMPortSamplesRes().printer(sys.stdout);
        IBA.PMPortSamplesRes().printer(sys.stdout,format="dotted");
        IBA.PMPortCounters().printer(sys.stdout);
        IBA.PMPortCounters().printer(sys.stdout,format="dotted");
        IBA.PMPortRcvErrorDetails().printer(sys.stdout);
        IBA.PMPortRcvErrorDetails().printer(sys.stdout,format="dotted");
        IBA.PMPortXmitDiscardDetails().printer(sys.stdout);
        IBA.PMPortXmitDiscardDetails().printer(sys.stdout,format="dotted");
        IBA.PMPortOpRcvCounters().printer(sys.stdout);
        IBA.PMPortOpRcvCounters().printer(sys.stdout,format="dotted");
        IBA.PMPortFlowCtlCounters().printer(sys.stdout);
        IBA.PMPortFlowCtlCounters().printer(sys.stdout,format="dotted");
        IBA.PMPortVLOpPackets().printer(sys.stdout);
        IBA.PMPortVLOpPackets().printer(sys.stdout,format="dotted");
        IBA.PMPortVLOpData().printer(sys.stdout);
        IBA.PMPortVLOpData().printer(sys.stdout,format="dotted");
        IBA.PMPortVLXmitFlowCtlUpdateErrors().printer(sys.stdout);
        IBA.PMPortVLXmitFlowCtlUpdateErrors().printer(sys.stdout,format="dotted");
        IBA.PMPortVLXmitWaitCounters().printer(sys.stdout);
        IBA.PMPortVLXmitWaitCounters().printer(sys.stdout,format="dotted");
        IBA.PMSwPortVLCongestion().printer(sys.stdout);
        IBA.PMSwPortVLCongestion().printer(sys.stdout,format="dotted");
        IBA.PMPortSamplesResExt().printer(sys.stdout);
        IBA.PMPortSamplesResExt().printer(sys.stdout,format="dotted");
        IBA.PMPortCountersExt().printer(sys.stdout);
        IBA.PMPortCountersExt().printer(sys.stdout,format="dotted");
        IBA.PMPortXmitDataSL().printer(sys.stdout);
        IBA.PMPortXmitDataSL().printer(sys.stdout,format="dotted");
        IBA.PMPortRcvDataSL().printer(sys.stdout);
        IBA.PMPortRcvDataSL().printer(sys.stdout,format="dotted");
        IBA.DMFormat().printer(sys.stdout);
        IBA.DMFormat().printer(sys.stdout,format="dotted");
        IBA.DMServiceEntry().printer(sys.stdout);
        IBA.DMServiceEntry().printer(sys.stdout,format="dotted");
        IBA.DMIOUnitInfo().printer(sys.stdout);
        IBA.DMIOUnitInfo().printer(sys.stdout,format="dotted");
        IBA.DMIOControllerProfile().printer(sys.stdout);
        IBA.DMIOControllerProfile().printer(sys.stdout,format="dotted");
        IBA.DMServiceEntries().printer(sys.stdout);
        IBA.DMServiceEntries().printer(sys.stdout,format="dotted");
        IBA.DMDiagnosticTimeout().printer(sys.stdout);
        IBA.DMDiagnosticTimeout().printer(sys.stdout,format="dotted");
        IBA.DMPrepareToTest().printer(sys.stdout);
        IBA.DMPrepareToTest().printer(sys.stdout,format="dotted");
        IBA.DMTestDeviceOnce().printer(sys.stdout);
        IBA.DMTestDeviceOnce().printer(sys.stdout,format="dotted");
        IBA.DMTestDeviceLoop().printer(sys.stdout);
        IBA.DMTestDeviceLoop().printer(sys.stdout,format="dotted");
        IBA.DMDiagCode().printer(sys.stdout);
        IBA.DMDiagCode().printer(sys.stdout,format="dotted");
        IBA.SNMPFormat().printer(sys.stdout);
        IBA.SNMPFormat().printer(sys.stdout,format="dotted");
